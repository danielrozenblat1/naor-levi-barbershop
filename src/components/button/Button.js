...
{props.href && <button onClick={openNaor} className={ props.loading ? styles.buttonL: styles.button}>
{props.text}
...
{!props.href && <button className={ props.loading ? styles.buttonL: styles.button}>
